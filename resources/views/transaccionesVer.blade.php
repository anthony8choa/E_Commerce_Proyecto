...
<body>
    ...
    <div class="container mt-5">
        ...
        @if ($todasFacturas != null)
            ...
            <section class="text-center text-white fw-bold fs-4 mb-3">Cantidad: {{ $cantidad }}</section>
        ...
        @else
            ...
            <section class="bg-white container row mt-5 p-3">
                <section class="col text-center fs-3 fw-bold">
                    Aun no tienes ningun pago efectuado
                </section>
            </section>
