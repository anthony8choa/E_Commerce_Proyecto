                ...
                <form>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td >
                                    <input type="text" class="form-control" name="imagenProducto" placeholder="Src de la imagen" required>
                                </td>
                            </tr>
                            <tr>
                                <td >
                            ...
                            <tr>
                                <td >
                                    <input type="number" class="form-control" name="cantidadDisponible" min="0" placeholder="Cantidad disponible de inicio" required>
                                </td>
                            </tr>
                        </tbody>
                    </table>
